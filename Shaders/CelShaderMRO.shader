...
Shader "Toon/CelShaderMRO" {
    Properties {
        _Tint("Color/Tint", color) = (1,1,1,1)
        _MainTex ("Texture", 2D) = "white" {}
        [NoScaleOffset]_NormalMap("Normals", 2D) = "bump" {}
        [NoScaleOffset]_MROMap("Metallic / Roughness / Occlusion", 2D) = "grey" {}
        ...
        _Occlusion("ambient Occlusion", Range(0,1)) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            {
                float3 mro = tex2D(_MROMap, i.uv);
                float glossFromMRO = mro.g;
                float occlFromMRO = mro.r;
                float metalFromMRO = mro.b;
        ...
        Pass {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                //diffuse lighting
                float lambert = dot(L, N) * occlFromMRO; //determine where shadow begins
